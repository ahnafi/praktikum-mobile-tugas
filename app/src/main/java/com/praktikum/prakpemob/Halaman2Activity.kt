...
import com.praktikum.prakpemob.databinding.ActivityHalaman2Binding
...
class Halaman2Activity : AppCompatActivity() {
    ...
    private fun initListener(){
        binding.layoutLocation.root.setOnClickListener{
            val gmapsIntentUri = "$gMapsUrl:$latitude,$longitude"
            val mapIntent = Intent(Intent.ACTION_VIEW, gmapsIntentUri.toUri())
